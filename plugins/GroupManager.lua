			...
			if is_JoinChannel(msg) then
				if is_owner(msg) then
					...
					if mr_roo[2]:lower() == 'msgs' or mr_roo[2] == 'پیام ها' then
						...
						for i = 1, 5 do
							tdbot.getChatHistory(msg.to.id, msg.id, 0,  5000, 0, cb, nil)
						end
						for i = 1, 2 do
							tdbot.getChannelMembers(msg.to.id, 0, 200, "Search", pro, nil)
						end
						for i = 1, 1 do
							tdbot.getChannelMembers(msg.to.id, 0, 200, "Recent", pro, nil)
						end
						for i = 1, 5 do
							tdbot.getChannelMembers(msg.to.id, 0, 200, "Banned", pro, nil)
						end
...
return M_START.."`گروه به مدت` *"..mr_roo[2].."* `ثانیه توسط` `"..msg.from.id.."` - @"..check_markdown(msg.from.username or '').." `قفل شد`"..EndPm
			...
			if (mr_roo[1]:lower() == 'link' or mr_roo[1] == "لینک") and not mr_roo[2] then
			...
			if (mr_roo[1] == "00" or mr_roo[1] == "01" or mr_roo[1] == "02" or mr_roo[1] == "03" or mr_roo[1] == "04" or mr_roo[1] == "05" or mr_roo[1] == "06" or mr_roo[1] == "07" or mr_roo[1] == "08" or mr_roo[1] == "09" or mr_roo[1] == "10" or mr_roo[1] == "11" or mr_roo[1] == "12" or mr_roo[1] == "13" or mr_roo[1] == "14" or mr_roo[1] == "15" or mr_roo[1] == "16" or mr_roo[1] == "17" or mr_roo[1] == "18" or mr_roo[1] == "19" or mr_roo[1] == "20" or mr_roo[1] == "21" or mr_roo[1] == "22" or mr_roo[1] == "23") and (mr_roo[2] == "00" or mr_roo[2] == "01" or mr_roo[2] == "02" or mr_roo[2] == "03" or mr_roo[2] == "04" or mr_roo[2] == "05" or mr_roo[2] == "06" or mr_roo[2] == "07" or mr_roo[2] == "08" or mr_roo[2] == "09" or mr_roo[2] == "10" or mr_roo[2] == "11" or mr_roo[2] == "12" or mr_roo[2] == "13" or mr_roo[2] == "14" or mr_roo[2] == "15" or mr_roo[2] == "16" or mr_roo[2] == "17" or mr_roo[2] == "18" or mr_roo[2] == "19" or mr_roo[2] == "20" or mr_roo[2] == "21" or mr_roo[2] == "22" or mr_roo[2] == "23" or mr_roo[2] == "24" or mr_roo[2] == "25" or mr_roo[2] == "26" or mr_roo[2] == "27" or mr_roo[2] == "28" or mr_roo[2] == "29" or mr_roo[2] == "30" or mr_roo[2] == "31" or mr_roo[2] == "32" or mr_roo[2] == "33" or mr_roo[2] == "34" or mr_roo[2] == "35" or mr_roo[2] == "36" or mr_roo[2] == "37" or mr_roo[2] == "38" or mr_roo[2] == "39" or mr_roo[2] == "40" or mr_roo[2] == "41" or mr_roo[2] == "42" or mr_roo[2] == "43" or mr_roo[2] == "44" or mr_roo[2] == "45" or mr_roo[2] == "46" or mr_roo[2] == "47" or mr_roo[2] == "48" or mr_roo[2] == "49" or mr_roo[2] == "50" or mr_roo[2] == "51" or mr_roo[2] == "52" or mr_roo[2] == "53" or mr_roo[2] == "54" or mr_roo[2] == "55" or mr_roo[2] == "56" or mr_roo[2] == "57" or mr_roo[2] == "58" or mr_roo[2] == "59") and redis:get(RedisIndex.."atolc"..msg.to.id..msg.sender_user_id) then
			...
			if mr_roo[1]:lower() == "lock" or mr_roo[1] == "قفل" then
				if mr_roo[2]:lower() == 'auto' or mr_roo[2] == 'خودکار' then
				...
				elseif mr_roo[2] == "link" or mr_roo[2] == "لینک" then
				...
				elseif mr_roo[2]:lower() == "english" or mr_roo[2] == "انگلیسی" then
