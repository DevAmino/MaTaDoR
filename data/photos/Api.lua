...
function PanelMenu(chatid, chatid2 ,Msgid, user_first, user)
	local Emoji = {"↫ ","⇜ ","⌯ ","↜ "}
	...
	text = Source_Start..'*کاربر* '..user1..' - `'..check_markdown(user_first)..'` *به پنل مدیریتی گروه* `[ '..Chat_id..' ]` *خوشآمدید*'..EndMsg..'\n'..Source_Start..'`برای حمایت از ما لطفا در نظر سنجی ربات شرکت کنید` ❤️\n\n'..Ch
	keyboard = {}
	keyboard.inline_keyboard = {
		...
		{
		{text = Source_Start.."تنظیمات بیشتر ⚙️", callback_data="LockSettingsMore:"..Chat_id}
		},
		{
		{text = Source_Start..'آنتی اسپم و فلود 🤖', callback_data = 'SpamSettings:'..Chat_id}
		},
		{
		{text = Source_Start..'اطلاعات گروه ♨️', callback_data = 'MoreSettings:'..Chat_id},
...
function LockSettingsMore(chatid, chatid2 ,Msgid, user_first, user)
	local Emoji = {"↫ ","⇜ ","⌯ ","↜ "}
	local Source_Start = Emoji[math.random(#Emoji)]
	if not chatid2 then
		Chat_id = chatid
	...
	local user1 = '['..user..'](tg://user?id='..user..')'
	local Ch = '[🏷 کانال ما](https://telegram.me/'..channel_inline..')'
	text = Source_Start..'*کاربر* '..user1..' - `'..check_markdown(user_first)..'` *به تنظیمات بیشتر گروه* `[ '..Chat_id..' ]` *خوشآمدید*'..EndMsg..'\n\n'..Ch
	local delbot = redis:get(RedisIndex.."delbot"..Chat_id) and "فعال | ✅" or "غیرفعال | ❌"
	local delbottime = redis:get(RedisIndex.."deltimebot"..Chat_id) or 60
	local mutetime = redis:get(RedisIndex.."TimeMuteset"..Chat_id) or 3600
	keyboard = {}
	keyboard.inline_keyboard = {
	{
	{text = Source_Start..'قفل گروه 💤', callback_data = 'LockSettingsLock:'..Chat_id}
	},
	{
	...
	{text = delbottime.." ثانیه 🔸", callback_data = 'Found:'..Chat_id},
	...
	{text = mutetime.." ثانیه 🔸", callback_data = 'Found:'..Chat_id},
...
function LockSettingsLock(chatid, chatid2 ,Msgid, user_first, user)
	local Emoji = {"↫ ","⇜ ","⌯ ","↜ "}
	local Source_Start = Emoji[math.random(#Emoji)]
	if not chatid2 then
		Chat_id = chatid
	...
	local user1 = '['..user..'](tg://user?id='..user..')'
	local Ch = '[🏷 کانال ما](https://telegram.me/'..channel_inline..')'
	text = Source_Start..'*کاربر* '..user1..' - `'..check_markdown(user_first)..'` *به تنظیمات قفل گروه* `[ '..Chat_id..' ]` *خوشآمدید*'..EndMsg..'\n\n'..Ch
	keyboard = {}
	keyboard.inline_keyboard = {
	{
	...
	{
	{text = Source_Start..'بازگشت 🎈', callback_data = 'LockSettingsMore:'..Chat_id}
	}
	}
	EditInline(chatid, text, chatid2, Msgid, "md", keyboard)
end
function SettingsLock(chatid, chatid2 ,Msgid, user_first, user)
	local Emoji = {"↫ ","⇜ ","⌯ ","↜ "}
	local Source_Start = Emoji[math.random(#Emoji)]
	if not chatid2 then
		Chat_id = chatid
	...
	local user1 = '['..user..'](tg://user?id='..user..')'
	local Ch = '[🏷 کانال ما](https://telegram.me/'..channel_inline..')'
	text = Source_Start..'*کاربر* '..user1..' - `'..check_markdown(user_first)..'` *به تنظیمات قفلی گروه* `[ '..Chat_id..' ]` *خوشآمدید*'..EndMsg..'\n*راهنمای ایموجی :*\n\n✍🏻 = `حالت اخطار`\n🚫 = `حالت اخراج`\n🔇 = `حالت سکوت`\n✓ = `فعال`\n✗ = `غیرفعال`\n\n'..Ch
	keyboard = {}
	keyboard.inline_keyboard = {
	{
...
function SettingsBots(chatid, chatid2 ,Msgid ,Bot, user_first, user)
	local Emoji = {"↫ ","⇜ ","⌯ ","↜ "}
	local Source_Start = Emoji[math.random(#Emoji)]
	if not chatid2 then
		Chat_id = chatid
...
function SettingsMute(chatid, chatid2 ,Msgid, user_first, user)
	local Emoji = {"↫ ","⇜ ","⌯ ","↜ "}
	local Source_Start = Emoji[math.random(#Emoji)]
	if not chatid2 then
		Chat_id = chatid
	...
	local user1 = '['..user..'](tg://user?id='..user..')'
	local Ch = '[🏷 کانال ما](https://telegram.me/'..channel_inline..')'
	text = Source_Start..'*کاربر* '..user1..' - `'..check_markdown(user_first)..'` *به تنظیمات رسانه گروه* `[ '..Chat_id..' ]` *خوشآمدید*'..EndMsg..'\n*راهنمای ایموجی :*\n\n✍🏻 = `حالت اخطار`\n🚫 = `حالت اخراج`\n🔇 = `حالت سکوت`\n✓ = `فعال`\n✗ = `غیرفعال`\n\n'..Ch
	keyboard = {}
	keyboard.inline_keyboard = {
	{
...
function locks(chatid,chatid2, name, Msgid, cb, back, v, st, user_first, user)
	local Emoji = {"↫ ","⇜ ","⌯ ","↜ "}
	local Source_Start = Emoji[math.random(#Emoji)]
	if not chatid2 then
		Chat_id = chatid
...
function SettingsSpam(chatid, chatid2 ,Msgid, user_first, user)
	local Emoji = {"↫ ","⇜ ","⌯ ","↜ "}
	local Source_Start = Emoji[math.random(#Emoji)]
	if not chatid2 then
		Chat_id = chatid
	...
	local user1 = '['..user..'](tg://user?id='..user..')'
	local Ch = '[🏷 کانال ما](https://telegram.me/'..channel_inline..')'
	text = Source_Start..'*کاربر* '..user1..' - `'..check_markdown(user_first)..'` *به تنظیمات آنتی اسپم و آنتی فلود گروه* `[ '..Chat_id..' ]` *خوشآمدید*'..EndMsg..'\n\n'..Ch
	keyboard = {}
	keyboard.inline_keyboard = {
	{
	...
	{
	{text = Source_Start..'حداکثر آنتی فلود ❄️', callback_data = 'Found:'..Chat_id}
	},
	{
...
function SettingsMore(chatid, chatid2 ,Msgid, user_first, user)
	local Emoji = {"↫ ","⇜ ","⌯ ","↜ "}
	local Source_Start = Emoji[math.random(#Emoji)]
	if not chatid2 then
		Chat_id = chatid
	...
	local user1 = '['..user..'](tg://user?id='..user..')'
	local Ch = '[🏷 کانال ما](https://telegram.me/'..channel_inline..')'
	text = Source_Start..'*کاربر* '..user1..' - `'..check_markdown(user_first)..'` *به تنظیمات  اطلاعات گروه* `[ '..Chat_id..' ]` *خوشآمدید*'..EndMsg..'\n\n'..Ch
	keyboard = {}
	keyboard.inline_keyboard = {
	{
	...
	{
	{text = Source_Start.."لیست مسدود ⚡️", callback_data="bans:"..Chat_id},
...
function SettingsAdd(chatid, chatid2 ,Msgid, user_first, user)
	local Emoji = {"↫ ","⇜ ","⌯ ","↜ "}
	local Source_Start = Emoji[math.random(#Emoji)]
	if not chatid2 then
		Chat_id = chatid
	...
	local user1 = '['..user..'](tg://user?id='..user..')'
	local Ch = '[🏷 کانال ما](https://telegram.me/'..channel_inline..')'
	text = Source_Start..'*کاربر* '..user1..' - `'..check_markdown(user_first)..'` *به تنظیمات اد اجباری گروه* `[ '..Chat_id..' ]` *خوشآمدید*'..EndMsg..'\n\n'..Ch
	...
	{
	{text = Source_Start..'فعال ✅', callback_data = 'addlimlock:'..Chat_id},
	{text = Source_Start..'غیرفعال ❌', callback_data = 'addlimunlock:'..Chat_id}
	},
	{
	{text = Source_Start..'ارسال پیام محدودیت : '..addpm..'', callback_data = 'Found:'..Chat_id}
	},
	{
	{text = Source_Start..'فعال ✅', callback_data = 'addpmon:'..Chat_id},
	{text = Source_Start..'غیرفعال ❌', callback_data = 'addpmoff:'..Chat_id}
	},
	{
	{text= Source_Start..'بازگشت 🎈' ,callback_data = 'MenuSettings:'..Chat_id}
	}
...
function HelpCode(chatid, chatid2 ,Msgid, user_first, user)
	local Emoji = {"↫ ","⇜ ","⌯ ","↜ "}
	local Source_Start = Emoji[math.random(#Emoji)]
	if not chatid2 then
		Chat_id = chatid
...
function LockMsg2(chatid, chatid2 ,Msgid, EN, FA)
	local Emoji = {"↫ ","⇜ ","⌯ ","↜ "}
	local Source_Start = Emoji[math.random(#Emoji)]
	if not chatid2 then
		Chat_id = chatid
...
function PanelCli(Msg)
	...
	if Msg.query and Msg.query:sub(1,6) == "Menu:-" and Msg.query:gsub("Menu:-",""):match('%d+') then
		...
		local user = '['..user_id..'](tg://user?id='..user_id..')'
		local Ch = '[🏷 کانال ما](https://telegram.me/'..channel_inline..')'
		local Text = Source_Start..'*کاربر* '..user..' - `'..check_markdown(user_first)..'` *به پنل مدیریتی گروه* `[ '..chatid..' ]` *خوشآمدید*'..EndMsg..'\n'..Source_Start..'`برای حمایت از ما لطفا در نظر سنجی ربات شرکت کنید` ❤️\n\n'..Ch
		keyboard = {}
		keyboard.inline_keyboard = {
		{
		{text = "💖 "..tostring(redis:get(RedisIndex.."Likes")), callback_data="Like:"..chatid},
		...
		{
		{text = Source_Start.."تنظیمات بیشتر ⚙️", callback_data="LockSettingsMore:"..chatid}
		},
		{
		{text = Source_Start..'آنتی اسپم و فلود 🤖', callback_data = 'SpamSettings:'..chatid}
		},
		{
		{text = Source_Start..'اطلاعات گروه ♨️', callback_data = 'MoreSettings:'..chatid},
		{text = Source_Start..'اد اجباری 📛', callback_data = 'AddSettings:'..chatid}
		},
		{
		{text = Source_Start..'پشتیبانی ربات 💻', callback_data = 'Manager:'..chatid}
	...
	if Msg.query and Msg.query:sub(1,6) == "Help:-" and Msg.query:gsub("Help:-",""):match('%d+') and is_sudo(Msg) then
		...
		local user_first = redis:get(RedisIndex.."TabchiUsername:"..chatid)
		local user_id = redis:get(RedisIndex.."TabchiUserId:"..chatid)
		local user1 = '['..user_id..'](tg://user?id='..user_id..')'
	local Ch = '[🏷 کانال ما](https://telegram.me/'..channel_inline..')'
	text = Source_Start..'*کاربر* '..user1..' - `'..check_markdown(user_first)..'` *به راهنمای ربات پیشرفته* `[ '..chatid..' ]` *خوشآمدید*'..EndMsg..'\n\n'..Ch
	keyboard = {}
	keyboard.inline_keyboard = {
	{
			...
			for i = 1, #updates.result do
				...
				if msg.callback_query then
					...
					if CmdMatches == 'Like:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						...
						PanelMenu(msg.inline_id, chat_id, msg_id, user_first, user_id)
					end
					...
					if CmdMatches == 'LockSettings:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						SettingsLock(msg.inline_id, chat_id, msg_id, user_first, user_id)
					end
					if CmdMatches == 'LockSettingsMore:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						LockSettingsMore(msg.inline_id, chat_id, msg_id, user_first, user_id)
					end
					if CmdMatches == 'LockSettingsLock:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						LockSettingsLock(msg.inline_id, chat_id, msg_id, user_first, user_id)
					end
					if CmdMatches == 'MuteSettings:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						SettingsMute(msg.inline_id, chat_id, msg_id, user_first, user_id)
					end
					if CmdMatches == 'SpamSettings:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						SettingsSpam(msg.inline_id, chat_id, msg_id, user_first, user_id)
					end
					if CmdMatches == 'MoreSettings:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						SettingsMore(msg.inline_id, chat_id, msg_id, user_first, user_id)
					end
					if CmdMatches == 'AddSettings:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						SettingsAdd(msg.inline_id, chat_id, msg_id, user_first, user_id)
					end
					if CmdMatches == 'locklink:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						...
						locks(msg.inline_id,chat_id,Source_Start..'قفل لینک',msg_id,'link','LockSettings:','لینک',st, user_first, user_id)
					end
					...
					if CmdMatches == 'lockviews:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						...
						locks(msg.inline_id,chat_id,Source_Start..'قفل بازدید',msg_id,'views','LockSettings:','بازدید',st, user_first, user_id)
					end
					...
					if CmdMatches == 'lockedit:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						...
						locks(msg.inline_id,chat_id,Source_Start..'قفل ویرایش پیام',msg_id,'edit','LockSettings:','ویرایش پیام',st, user_first, user_id)
					end
					...
					if CmdMatches == 'locktags:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						...
						locks(msg.inline_id,chat_id,Source_Start..'قفل تگ',msg_id,'tag','LockSettings:','تگ',st, user_first, user_id)
					end
					...
					if CmdMatches == 'lockusernames:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						...
						locks(msg.inline_id,chat_id,Source_Start..'قفل نام کاربری',msg_id,'usernames','LockSettings:','نام کاربری',st, user_first, user_id)
					end
					...
					if CmdMatches == 'lockmention:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						...
						locks(msg.inline_id,chat_id,Source_Start..'قفل منشن',msg_id,'mention','LockSettings:','منشن',st, user_first, user_id)
					end
					...
					if CmdMatches == 'lockarabic:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						...
						locks(msg.inline_id,chat_id,Source_Start..'قفل فارسی',msg_id,'farsi','LockSettings:','فارسی',st, user_first, user_id)
					end
					...
					if CmdMatches == 'lockwebpage:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						...
						locks(msg.inline_id,chat_id,Source_Start..'قفل وبسایت',msg_id,'web','LockSettings:','وبسایت',st, user_first, user_id)
					end
					...
					if CmdMatches == 'lockmarkdown:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						...
						locks(msg.inline_id,chat_id,Source_Start..'قفل فونت',msg_id,'markdown','LockSettings:','فونت',st, user_first, user_id)
					end
					...
					if CmdMatches == 'mutevideonote:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						...
						locks(msg.inline_id,chat_id,Source_Start..'قفل فیلم سلفی',msg_id,'note','MuteSettings:','فیلم سلفی',st, user_first, user_id)
					end
					...
					if CmdMatches == 'mutegif:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						...
						locks(msg.inline_id,chat_id,Source_Start..'قفل گیف',msg_id,'gif','MuteSettings:','گیف',st, user_first, user_id)
					end
					...
					if CmdMatches == 'mutetext:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						...
						locks(msg.inline_id,chat_id,Source_Start..'قفل متن',msg_id,'text','MuteSettings:','متن',st, user_first, user_id)
					end
					...
					if CmdMatches == 'muteinline:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						...
						locks(msg.inline_id,chat_id,Source_Start..'قفل دکمه شیشه ای',msg_id,'inline','MuteSettings:','دکمه شیشه ای',st, user_first, user_id)
					end
					...
					if CmdMatches == 'mutegame:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						...
						locks(msg.inline_id,chat_id,Source_Start..'قفل بازی',msg_id,'game','MuteSettings:','بازی',st, user_first, user_id)
					end
					...
					if CmdMatches == 'mutephoto:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						...
						locks(msg.inline_id,chat_id,Source_Start..'قفل عکس',msg_id,'photo','MuteSettings:','عکس',st, user_first, user_id)
					end
					...
					if CmdMatches == 'mutevideo:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						...
						locks(msg.inline_id,chat_id,Source_Start..'قفل فیلم',msg_id,'video','MuteSettings:','فیلم',st, user_first, user_id)
					end
					...
					if CmdMatches == 'muteaudio:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						...
						locks(msg.inline_id,chat_id,Source_Start..'قفل آهنگ',msg_id,'audio','MuteSettings:','آهنگ',st, user_first, user_id)
					end
					...
					if CmdMatches == 'mutevoice:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						...
						locks(msg.inline_id,chat_id,Source_Start..'قفل ویس',msg_id,'voice','MuteSettings:','ویس',st, user_first, user_id)
					end
					...
					if CmdMatches == 'mutesticker:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						...
						locks(msg.inline_id,chat_id,Source_Start..'قفل استیکر',msg_id,'sticker','MuteSettings:','استیکر',st, user_first, user_id)
					end
					...
					if CmdMatches == 'mutecontact:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						...
						locks(msg.inline_id,chat_id,Source_Start..'قفل مخاطب',msg_id,'contact','MuteSettings:','مخاطب',st, user_first, user_id)
					end
					...
					if CmdMatches == 'muteforwardch:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						...
						locks(msg.inline_id,chat_id,'⇜ قفل فوروارد کانال',msg_id,'fwd','muteforward:','فوروارد کانال',st, user_first, user_id)
					end
					if CmdMatches == 'muteforwarduser:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						...
						locks(msg.inline_id,chat_id,'⇜ قفل فوروارد کاربر',msg_id,'fwduser','muteforward:','فوروارد کاربر',st, user_first, user_id)
					end
					...
					if CmdMatches == 'mutelocation:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						...
						locks(msg.inline_id,chat_id,'⇜ قفل مکان',msg_id,'location','MuteSettings:','مکان',st, user_first, user_id)
					end
					...
					if CmdMatches == 'mutedocument:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						...
						locks(msg.inline_id,chat_id,'⇜ قفل فایل',msg_id,'document','MuteSettings:','فایل',st, user_first, user_id)
					end
					...
					if CmdMatches == 'mutekeyboard:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						...
						locks(msg.inline_id,chat_id,'⇜ قفل کیبورد شیشه ای',msg_id,'keyboard','MuteSettings:','کیبورد شیشه ای',st, user_first, user_id)
					end
					...
					if CmdMatches == 'lockbots:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						...
						SettingsBots(msg.inline_id, chat_id, msg_id ,Bot, user_first, user_id)
					end
					if CmdMatches == 'lockbotskickbot:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						...
						SettingsBots(msg.inline_id, chat_id, msg_id, "اخراج ربات", user_first, user_id)
					end
					if CmdMatches == 'lockbotsdisable:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						...
						SettingsBots(msg.inline_id, chat_id, msg_id, "غیرفعال", user_first, user_id)
					end
					if CmdMatches == 'lockbotskickuser:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						...
						SettingsBots(msg.inline_id, chat_id, msg_id, "اخراج ربات و کاربر", user_first, user_id)
					end
					...
					if CmdMatches == 'delbotup:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						...
						if tonumber(flood_max) < 300 then
							flood_max = tonumber(flood_max) + 10
					...
					if CmdMatches == 'ExitPanel:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						user = '['..user_id..'](tg://user?id='..user_id..')'
						local Ch = '[🏷 کانال ما](https://telegram.me/'..channel_inline..')'
						EditInline(msg.inline_id, Source_Start.."`پنل مدیرتی ربات توسط` "..user.." - *"..es_name(user_first).."* `بسته شد`"..EndMsg.."\n\n"..Ch, chat_id, msg_id, "md")
					end
					if CmdMatches == 'ExitHelp:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						user = '['..user_id..'](tg://user?id='..user_id..')'
						local Ch = '[🏷 کانال ما](https://telegram.me/'..channel_inline..')'
						EditInline(msg.inline_id, Source_Start.."`پنل راهنمای ربات توسط` "..user.." - *"..es_name(user_first).."* `بسته شد`"..EndMsg.."\n\n"..Ch, chat_id, msg_id, "md")
					end
					if CmdMatches == 'Manager:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						...
						EditInline(msg.inline_id, Source_Start.."`کاربر` "..user.." - *"..es_name(user_first).."* `به پشتیبانی ربات خوشآمدید`"..EndMsg.."\n\n"..Ch, chat_id, msg_id, "md" ,keyboard)
					end
					if CmdMatches == 'HelpCode:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						HelpCode(msg.inline_id, chat_id, msg_id, user_first, user_id)
					end
					...
					if CmdMatches == 'Hbot:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						Text = [[
					...
					if CmdMatches == 'Hall:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						LockMsg2(msg.inline_id, chat_id, msg_id, "all", "همه")
					end
					if CmdMatches == 'Htab:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						LockMsg2(msg.inline_id, chat_id, msg_id, "tabchi", "تبچی")
					end
					if CmdMatches == 'Hspam:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						LockMsg2(msg.inline_id, chat_id, msg_id, "spam", "هرزنامه")
					end
					if CmdMatches == 'Hflood:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						LockMsg2(msg.inline_id, chat_id, msg_id, "flood", "پیام مکرر")
					end
					if CmdMatches == 'Hjoin:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						LockMsg2(msg.inline_id, chat_id, msg_id, "join", "ورود")
					end
					if CmdMatches == 'Hpin:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						LockMsg2(msg.inline_id, chat_id, msg_id, "pin", "سنجاق")
					end
					if CmdMatches == 'Htg:'..chat_id and Modcheck(Msg, chat_id, user_id, user_first) then
						LockMsg2(msg.inline_id, chat_id, msg_id, "tgservice", "سرویس تلگرام")
					end
				end
			end
		end
